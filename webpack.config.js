...
const aliases = jsconfigJson.compilerOptions.paths ? Object.fromEntries(
    Object
        .keys(jsconfigJson.compilerOptions.paths)
        .map(key=>[
            key,
            path.resolve(__dirname, jsconfigJson.compilerOptions.paths[key][0])
        ])
):{}
